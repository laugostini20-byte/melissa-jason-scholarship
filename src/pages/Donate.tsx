      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md mb-8">
            <h2 className="text-2xl font-bold mb-6 text-center text-navy">Donate via QR Code</h2>
            <div className="flex flex-col items-center">
              <div className="w-64 h-64 bg-gray-200 rounded-lg flex items-center justify-center mb-6">
                <span className="text-gray-400 text-lg">QR Code Placeholder</span>
              </div>
              <p className="text-gray-600 mb-4">Scan this QR code with your mobile device to donate</p>
            </div>
          </div>

          <div className="bg-light-gray p-8 rounded-lg text-center">
            <h2 className="text-2xl font-bold mb-6 text-navy">Donate Online</h2>
            <p className="text-lg text-gray-700 mb-8">
              Click the button below to be redirected to our secure donation page.
            </p>
            <button
              onClick={handleDonateClick}
              className="bg-gold text-navy px-8 py-3 rounded-lg font-semibold hover:bg-gold/90 transition-colors text-lg"
            >
              Donate Now
            </button>
          </div>
          ...
          <div className="mt-12 bg-white p-8 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-navy">Other Ways to Give</h3>
